...
def manifest():
    ...
    return jsonify({
        ...
        "endpoints": [
            ...
            {"method": "POST", "path": "/agent/admin/score",
             "purpose": "Run lead scoring on demand (heuristic + optional Gemini refinement).",
             "body": {"person_ids": "list of person ids to rescore (force=True implied)",
                      "pending": "true -> score everything stale/never-scored",
                      "limit": "default 100 (pending mode)",
                      "force": "rescore even if recently scored",
                      "use_ai": "false to skip the AI layer"},
             "returns": {"ok": True, "requested": 0, "scored": 0, "skipped": 0, "errors": 0, "results": []}},
            {"method": "POST", "path": "/agent/admin/number-lookup",
             "purpose": "Bulk-classify pending phones via Telnyx Number Lookup. Cost-conservative defaults: high-score T65 leads only.",
             "body": {"limit": 100, "max_spend_usd": 5,
                      "min_score": "default 70",
                      "source_patterns": "default ['T65_'] — list of source prefixes",
                      "owner": "optional agent owner filter",
                      "dialable_stages": "default ['new','attempted','voicemail','callback']",
                      "sleep_between_seconds": "default 0.05"},
             "returns": {"ok": True, "requested": 0, "processed": 0, "classified": 0,
                         "deactivated": 0, "spend_today_usd": 0, "stopped_for_budget": False,
                         "filters": {}}},
